...
all_DMSO <- read.csv(file = 'refit_HL_DMSOMED26_Summary_scRNA-ss-HCT116MD_2.csv')

all_burst_DMSO <- read.csv(file = 'refit_HL_DMSOMED26_burst_scRNA-ss-HCT116MD_MED26DDMSOr2_2.csv')
...
all_AUXIN <- read.csv(file = 'refit_HL_MED26_Summary_scRNA-ss-HCT116MA_2.csv')

all_burst_AUXIN <- read.csv(file = 'refit_HL_MED26_burst_scRNA-ss-HCT116MA_MED26DIAAr2_2.csv')
...
down <- read.csv(file = 'med26_down.csv')
others <- read.csv(file = 'med26_others.csv')
...
ggplot(DMSO_AUXIN_horizontal_filter, aes(x=cat_IAA_120_bulk, y= log2(Expression.y/Expression.x), color=cat_IAA_120_bulk))  + 
  ...
  ylab("log2 (MED26/DMSO) Expression") + ylim(-4, 4) 
