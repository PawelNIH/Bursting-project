...
all_DMSO <- read.csv(file = 'T0_DMSO_Summary_scRNA-ss-HCT116_2.csv')

all_burst_DMSO <- read.csv(file = 'T0_DMSO_burst_scRNA-ss-HCT116_HCTDMSO0h_2.csv')
...
all_AUXIN <- read.csv(file = 'T0_AUXIN_Summary_scRNA-ss-HCT116_2.csv')

all_burst_AUXIN <- read.csv(file = 'T0_AUXIN_burst_scRNA-ss-HCT116_HCTAUXIN0h_2.csv')
