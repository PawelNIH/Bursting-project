...
all_DMSO <- read.csv(file = 'Summary_scRNA-ss-ESCDMSO_2.csv')

all_burst_DMSO <- read.csv(file = 'burst_scRNA-ss-ESC_ESCCDMSO_2.csv')
...
all_AUXIN <- read.csv(file = 'Summary_scRNA-ss-ESCAUXIN_2.csv')

all_burst_AUXIN <- read.csv(file = 'burst_scRNA-ss-ESC_ESCCAUXIN_2.csv')
