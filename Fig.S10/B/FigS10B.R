...
all_DMSO <- read.csv(file = 'T30_DMSO_Summary_scRNA-ss-HCT116_2.csv')

all_burst_DMSO <- read.csv(file = 'T30_DMSO_burst_scRNA-ss-HCT116_HCTDMSO30m_2.csv')
...
all_AUXIN <- read.csv(file = 'T30_AUXIN_Summary_scRNA-ss-HCT116_2.csv')

all_burst_AUXIN <- read.csv(file = 'T30_AUXIN_burst_scRNA-ss-HCT116_HCTAUXIN30m_2.csv')
